<template>
  <div>
    <h2 id="page-heading" data-cy="TeamHeading">
      <span v-text="t$('bugTrackerJhipsterApp.team.home.title')" id="team-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('bugTrackerJhipsterApp.team.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TeamCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-team">
            ...
            <span v-text="t$('bugTrackerJhipsterApp.team.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && teams && teams.length === 0">
      <span v-text="t$('bugTrackerJhipsterApp.team.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="teams">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('bugTrackerJhipsterApp.team.name')"></span></th>
            <th scope="row"><span v-text="t$('bugTrackerJhipsterApp.team.description')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="bugTrackerJhipsterApp.team.delete.question" data-cy="teamDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-team-heading" v-text="t$('bugTrackerJhipsterApp.team.delete.question', { id: removeId })"></p>
      </div>
